...
| azmcp_sql_db_restore | Restore database <database_name> from server <server_name> at <restore_point> into <target_database_name> |
| azmcp_sql_db_restore | Restore the SQL database <database_name> on server <server_name> to point-in-time <restore_point> and name it <target_database_name> |
